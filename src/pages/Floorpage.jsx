  ...
  try {
    ...
    const fetchPromises = roomdata
      ...
      .map(async (room) => {
        ...
        try {
          const res = await fetch(`https://dr-backend-32ec.onrender.com/periods/${encodedName}`);
          if (res.ok) {
...
const getCurrentPeriod = (timetable, testHour = null, testMin = null) => {
  ...
  try {
    await axios.delete(`https://dr-backend-32ec.onrender.com/periods/class/${className}`);
